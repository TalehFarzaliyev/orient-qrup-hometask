...
if ($_SESSION['logged_in'] == 1) {
    ...
    $id_painter = (isset($_GET['painter'])) ? intval($_GET['painter']) : 0;
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_POST['post-type']) and !empty($_POST['post-type']) and $_POST['post-type'] == 'create') {
            ...
            $insert_works   = "INSERT INTO `works`(`id_painter`,`work_image`,`status`) VALUES ('$id_painter','$image','$status')";
            ...
            header("Location: works.php?painters=$id_painter");
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        ?>
                            ...
                            <br>
                            <form action="form-works.php?painter=<?=$id_painter?>" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-4 form-section">
                                        ...
                                        <div class="form-group img-section">
                                            ...
                                            <img class="preview-img" id='previewImage-create' src="../uploads/noPhoto.png" class="img-thumbnail" style="width:50%; height:auto;" alt="">
                                            ...
                                            ?>
                                                <div class="tab-pane fade show <?php if ($row['code'] == 'az') echo 'active' ?>" id="nav-<?= $row['code']; ?>" role="tabpanel" aria-labelledby="nav-<?= $row['code']; ?>-tab">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="translation[<?= $row['id'] ?>][work_name]" class="form-control" id="exampleFormControlInput1" placeholder="Əsərin adı">
                                                    </div>
                                                </div>
                                            <?php
                                            }
                        ...
                        ?>
                            ...
                            <br>
                            <form action="form-works.php?id=<?=$work_id;?>&painter=<?=$id_painter?>" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-4 form-section">
                                        <br>
                                            ...
                                            ?>
                                                <div class="tab-pane fade show <?php if ($value['code'] == 'az') echo 'active' ?>" id="nav-<?= $value['code']; ?>" role="tabpanel" aria-labelledby="nav-<?= $value['code']; ?>-tab">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="translation[<?= $value['lang_id'] ?>][work_name]" value="<?= $value['work_name']; ?>" class="form-control" id="exampleFormControlInput1" placeholder="Başlıq">
                                                    </div>
                                                </div>
                                            <?php
                                            }
