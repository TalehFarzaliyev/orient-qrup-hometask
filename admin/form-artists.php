...
if ($_SESSION['logged_in'] == 1) {
    ...
    $post_type = (isset($_GET['id_artist'])) ? 'edit' : 'create';
    $painter_id = (isset($_GET['id_artist'])) ? intval($_GET['id_artist']) : 0;
    $selected_category = [];
    if (!empty($painter_id)) {
        $sql              = "SELECT * FROM `painters` WHERE `id_artist`=$painter_id";
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_POST['post-type']) and !empty($_POST['post-type']) and $_POST['post-type'] == 'create') {
            ...
            $update_painter  = "UPDATE `painters` SET `painter_name`='$painter_name', `painter_surname`='$painter_surname', `painter_image`='$image',`status`='$status' WHERE `id_artist`=$painter_id";
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        ?>
                            ...
                            <br>
                            <form action="form-artists.php" method="post" enctype="multipart/form-data">
                                <div class="row">
                                                        ...
                                                        ?>
                                                            <div class="tab-pane fade show <?php if ($row['code'] == 'az') echo 'active' ?>" id="nav-<?= $row['code']; ?>" role="tabpanel" aria-labelledby="nav-<?= $row['code']; ?>-tab">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="translation[<?= $row['id'] ?>][about_painter]" class="form-control" id="exampleFormControlInput1" placeholder="Haqqında">
                                                                </div>
                                                            </div>
                                                        <?php
                                                        }
                        ...
                        ?>
                            <h1 class="h3 mb-2 text-gray-800">Rəssamlar haqqındakı məlumatı redaktə et</h1>
                            <br>
                            <!-- DataTales Example -->
                            <form action="form-artists.php?id=<?= $id_artist; ?>" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-4 form-section">

                                        <div class="form-group">
                                            <label for="exampleFormControlInput1" class="form-label">Rəssamın adı</label>
                                            <input type="text" class="form-control" style="margin: 6px 0" ; name="painter_name" value="<?= $painter_row['painter_name']; ?>" id="exampleFormControlInput1">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleFormControlInput1" class="form-label">Rəssamın Soyadı</label>
                                            <input type="text" name="painter_surname" value="<?= $painter_row['painter_surname']; ?>" class="form-control" id="exampleFormControlInput1">
                                        </div>
                                        <div class="form-group img-section">
                                            <label for="exampleFormControlFile1">Şəkil</label>
                                    ...
                                    <div class="tab-content" id="nav-tabContent">
                                        ...
                                        ?>
                                            <div class="tab-pane fade show <?php if ($value['code'] == 'az') echo 'active' ?>" id="nav-<?= $value['code']; ?>" role="tabpanel" aria-labelledby="nav-<?= $value['code']; ?>-tab">
                                                <div class="form-group">
                                                    <label for="exampleFormControlInput1" class="form-label" style="margin-top: 20px;">Haqqında məlumat</label>
                                                    <input type="text" class="form-control" name="translation[<?= $value['lang_id'] ?>][about_painter]" value="<?= $value['about_painter']; ?>" id="exampleFormControlInput1">
                                                </div>
                                            </div>
                                        <?php
                                        }
