        ...
        <div class="form-section container">
            ...
            <form>
                <div class="form-log row">
                    <input class="form-input col-xl-6 col-lg-6 col-md-6 col-sm-12" type="name" name="name" placeholder="<?=translate('name', $lang_name); ?>">
                    <input class="form-input col-xl-6 col-lg-6 col-md-6 col-sm-12" type="email" name="email" placeholder="<?=translate('mail', $lang_name); ?>">
                </div>
                <input class="form-input form-item" type="text" name="movzu" placeholder="<?=translate('content', $lang_name); ?>">
                <textarea class="form-input form-item" name="textarea" cols="30" rows="10" placeholder="<?=translate('letter', $lang_name); ?>"></textarea>
